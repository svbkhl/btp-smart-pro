-- KPI par propriétaire de leads (tous ceux qui ont au moins un lead assigné), même s'ils ne sont pas dans closer_emails.
-- Utilisé en fallback pour afficher les "closers" quand closer_emails est vide.
