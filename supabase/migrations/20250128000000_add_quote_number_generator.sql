-- Fonction pour générer le prochain numéro de devis séquentiel
...
COMMENT ON FUNCTION get_next_quote_number() IS 'Génère le prochain numéro de devis au format DEV-YYYY-NNNN de manière séquentielle';
