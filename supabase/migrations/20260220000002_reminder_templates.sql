-- =====================================================
-- RELANCES FACTURES - Tables reminder_templates et payment_reminders
-- =====================================================
...
-- Fonction pour obtenir les factures impayées
...
BEGIN
  ...
  SELECT 
    ...
    i.client_name,
    i.client_email,
    COALESCE(i.total_ttc, i.amount)::DECIMAL as amount_ttc,
    i.due_date::DATE,
...
-- Templates par défaut pour chaque entreprise
