...
export function PrivacyPolicySection({ className }: { className?: string }) {
  return (
...
export function MentionsLegalesSection({ className }: { className?: string }) {
  return (
    <section className={cn("pt-6 border-t border-border/50", className)}>
...
export function TermsOfUseSection({ className }: { className?: string }) {
  return (
    <section className={cn("pt-6 border-t border-border/50", className)}>
...
/** Bloc unique pour l’onglet Paramètres (scroll interne) — même export qu’avant pour Settings */
