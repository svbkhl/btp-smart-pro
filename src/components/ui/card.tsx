...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("rounded-xl border border-white/10 dark:border-white/5 bg-white/5 dark:bg-black/10 backdrop-blur-md text-card-foreground shadow-sm", className)} {...props} />
));
