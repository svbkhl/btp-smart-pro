...
import { QuoteSignature } from "@/components/ai/QuoteSignature";
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <Tabs defaultValue="quote" className="w-full">
              <TabsList className="flex overflow-x-auto w-full mb-4 md:mb-6 h-auto flex-nowrap gap-1 p-1">
                ...
                <TabsTrigger value="assistant" className="flex-shrink-0 text-xs md:text-base px-3 md:px-6 py-2 md:py-3">Assistant</TabsTrigger>
                <TabsTrigger value="analysis" className="flex-shrink-0 text-xs md:text-base px-3 md:px-6 py-2 md:py-3">Analyse</TabsTrigger>
                <TabsTrigger value="signature" className="flex-shrink-0 text-xs md:text-base px-3 md:px-6 py-2 md:py-3">Signature</TabsTrigger>
