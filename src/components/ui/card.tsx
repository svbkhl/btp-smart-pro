...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("rounded-xl border border-white/20 dark:border-white/10 bg-transparent backdrop-blur-xl text-card-foreground shadow-sm", className)} {...props} />
));
